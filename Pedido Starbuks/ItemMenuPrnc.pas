...
type
  ...
  public
    { Public declarations }
    function Recursos(Texto : String; ResourceImage : String) : TItemMenuPrincipal;
...
function TItemMenuPrincipal.Recursos(Texto : String; ResourceImage : String) : TItemMenuPrincipal;
begin
  Result := Self;
  Label1.Text := Texto;
